...
export async function getSuggestions(productionData: string) {
  ...
  try {
    ...
    return {
      suggestions: ["An error occurred while fetching suggestions. Please try again later."],
      reasoning: "The AI service might be temporarily unavailable or there was an internal error."
    }
  }
}
